...
public class ClientProtocol {  
    ...
    public void doProtocol(){
        ...
        String command = sc.nextLine();//Input command
        command = command.toUpperCase();//Upercase
        if(player.getAvailableCommands().contains(command)){
        ...
        switch(command){
            ...
            case "BET":
                try {
                    ...
                    int chips = protFunc.getScannerInt(sc); //Read chips
            ...
            case "RAISE":
                try {
                    ...
                    if(player.getBalance()>0){
                        System.out.println("Enter bet:");
                        int chips3 = protFunc.getScannerInt(sc); //Read chips
            ...
            case "DRAW":
                try {
                    //Sends DRAW
                    protFunc.clientDraw(comUtils, player, sc);
                    //Read DRWS
                    serverResponseManagement();
                } catch (IOException ex) {
                    try {
    ...
    private void serverResponseManagement() throws IOException{
        ...
        switch(command){
            case "ANTE"://Read minimumbet of server
                ...
                String commandsAnte[] = {"ANTE_OK","QUIT"};
            ...
            case "STKS": //Read actual stack
                ...
                String commandsStks[] = {"ANTE_OK","QUIT"};
            ...
            case "BET_": //Read bet from server
                ...
                String commandsBet[] = {"CALL","RAISE","FOLD","QUIT"};
            ...
            case "PASS": //Read pass from server
                ...
                if(!dataServer.isHasDraw()){
                    if(dataServer.getDeal().equals("0")){ //Deal 0 //ya habriamos apostado por tanto descartamos o nos vamos
                        ...
                        String commandsPass[] = {"BET","PASS","FOLD","QUIT"};
                        player.setAvailableCommands(new ArrayList<String>(Arrays.asList(commandsPass)));
                    }
                }
            ...
            case "RISE": //Read a raise from server  
                ...
                String commandsRise[] = {"CALL","RAISE","QUIT"};
            ...
            case "DRWS":
                ...
                if(dataServer.getDeal().equals("0")){ //Deal 0 //ya habriamos apostado por tanto descartamos o nos vamos
                    String commandsDrws[] = {"BET","PASS","FOLD","QUIT"};
                    player.setAvailableCommands(new ArrayList<String>(Arrays.asList(commandsDrws)));
                }
                else{//Deal 1
                    String commandsDrws[] = {"CALL","RAISE","FOLD","QUIT"};
                    player.setAvailableCommands(new ArrayList<String>(Arrays.asList(commandsDrws)));
     ...
     */
    public void askId(){
        System.out.println("Put ID number: ");
        int playerId = 0;
        playerId = protFunc.getScannerInt(sc);
